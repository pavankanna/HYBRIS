...
public class DefaultMatchFacadeTest
{
	...
	public void testGetGroups()
	{
		...
		group1.setLocaleProvider(new StubLocaleProvider(Locale.GERMAN));
		group1.setCode("codeGroup1");
		group1.setName("nameGroup1");
		group1.setCompetition(comp);
		final GroupModel group2 = new GroupModel();
		group2.setLocaleProvider(new StubLocaleProvider(Locale.GERMAN));
	...
	public void testGetMatches()
	{
		...
		group.setLocaleProvider(new StubLocaleProvider(Locale.GERMAN));
		group.setCode("test");
		...
		homeTeam.setLocaleProvider(new StubLocaleProvider(Locale.GERMAN));
		...
		guestTeam.setLocaleProvider(new StubLocaleProvider(Locale.GERMAN));
	...
	public void testGetLatestNews()
	{
		...
		news1.setLocaleProvider(new StubLocaleProvider(Locale.GERMAN));
	...
	public void testGetClosedBets()
	{
		...
		countrFlag.getValueHistory().markDirty("downloadurl");
		...
		profile1.getValueHistory().markDirty("downloadurl");
		...
		profile2.getValueHistory().markDirty("downloadurl");
