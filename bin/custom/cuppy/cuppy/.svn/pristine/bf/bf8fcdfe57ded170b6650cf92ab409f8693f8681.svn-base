...
public class DefaultPlayerFacadeTest
{
	...
	public void testRankingNoUser()
	{
		...
		defaultPicture.getValueHistory().markDirty("downloadURL");
			...
			final String playerName)
	{
		...
		flag.getValueHistory().markDirty("downloadURL");
		...
		profile.getValueHistory().markDirty("downloadURL");
	...
	public void testRegistration()
	{
		...
		final PlayerModel player = new PlayerModel();
		player.setLocaleProvider(new StubLocaleProvider(Locale.GERMANY));
		...
		assertEquals(data.getLocale().getCountry().toLowerCase(), cap.getValue().getCountry().getIsocode());
		assertEquals(data.getName(), cap.getValue().getName());
		assertEquals(data.getLocale().getLanguage().toLowerCase(), cap.getValue().getSessionLanguage().getIsocode());
	...
	public void testGetAllCountries()
	{
		...
		assertEquals(country1.getIsocode(), result.get(0).getCountry().toLowerCase());
		assertEquals(country2.getIsocode(), result.get(1).getCountry().toLowerCase());
	...
	public void testUploadProfilePicture()
	{
		...
		pic.getValueHistory().markDirty("downloadurl");
