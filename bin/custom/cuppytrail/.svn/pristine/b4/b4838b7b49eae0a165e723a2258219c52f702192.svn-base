 ...
 * provides the required business level functionality of the Stadium Service in the Service layer, wrapping calls to a
 * Stadium DAO.
 */
@TenantScopedComponent(value = "stadiumService")
public class DefaultStadiumService implements StadiumService
{
	...
	@Override
	public List<ProductModel> getAllStadiumProducts()
	{
		return stadiumDAO.getAllStadiumProducts();
	}

	/**
	 * Sets the {@link StadiumDAO} to use for finding stadiums.
	 */
