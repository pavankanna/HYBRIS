...
@TenantScopedComponent(value = "stadiumDAO")
public class DefaultStadiumDAO implements StadiumDAO
{
	 ...
	 * 
	 * @see "https://wiki.hybris.com/display/release4/FlexibleSearch"
	 */
	@Autowired
	...
	{
		final String query = "SELECT {" + Item.PK + "}FROM {" + ProductModel._TYPECODE + " } ";
